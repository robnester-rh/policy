...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/source_image/source_image.rego#L17[Source, window="_blank"]
...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/source_image/source_image.rego#L32[Source, window="_blank"]
