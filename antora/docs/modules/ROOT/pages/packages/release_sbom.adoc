...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/sbom/sbom.rego#L37[Source, window="_blank"]
...
* Code: `sbom.found`
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/sbom/sbom.rego#L16[Source, window="_blank"]
...
*Solution*: Check that the SBOM was signed with the key or certificate configured in the "sbom" entry of the xref:signing_identities.adoc#_signing_identities_structure[signing_identities] rule data, or that the signing identity matches.

* Rule type: [rule-type-indicator warning]#WARNING#
* WARNING message: `%s`
* Code: `sbom.signature_verification`
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/sbom/sbom.rego#L58[Source, window="_blank"]
